...
<table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td class="innerpadding borderbottom" style="padding-top: 0px;">
            ...
            Thank you for being a part of Prosper. You can reset password from bellow link:
            <a href="{{ route('password.reset', $token) }}" >Reset Password
                </a>
        </td>
    </tr>
    <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody><tr>
                    <td align="center" class="footercopy">
                        © {{ date('Y') }} Prosper, All rights reserved.
                    </td>
                </tr>
                <tr>
