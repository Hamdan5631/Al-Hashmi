...
<div class="page">
    <div class="header">
        <div class="container">
            <p class="title">Return and Refund Policy for Auctopets</p>
        </div>
    </div>
    <div class="translations-content-container">
        <div class="container">
            <div class="tab-content translations-content-item en visible" id="en">
                ...
                <p>Thank you for shopping at Auctopets.</p>
                ...
                <ul>
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Auctopets.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Auctopets, accessible from <a href="www.auctopets.com" rel="external nofollow noopener" target="_blank">www.auctopets.com</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: auctopets@gmail.com</li>
                </ul>
