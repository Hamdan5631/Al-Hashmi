...
<div class="page">
    <div class="header">
        <div class="container">
            <p class="title">Privacy Policy for Auctopets</p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="tab-content translations-content-item en visible" id="en">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Abond, Kolathur.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Auctopets, accessible from <a href="https://auctopets.com" rel="external nofollow noopener" target="_blank">www.abond.in</a></p>
                    </li>
                    <li>
